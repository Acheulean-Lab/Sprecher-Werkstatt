  ...
  return (
    <div className="panel">
      <div className="panel-head">
        <span className="spec-label">Impulse response</span>
        <span className="spec-label">amplitude / ms</span>
      </div>
      <div className="p-4">
      <ResponsiveContainer width="100%" height={260}>
        <LineChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 10 }}>
          ...
          <Tooltip contentStyle={{ background: '#000000', border: '1px solid #3F3F46', borderRadius: 0, fontSize: 12 }} itemStyle={{ color: '#9C9A96' }} formatter={(v: unknown) => Number(v).toFixed(4)} />
